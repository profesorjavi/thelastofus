...
### **Objetivo**  
Instalar y configurar un servidor FTP seguro que permita a cada superviviente actualizar su página web en su directorio personal sin necesidad de acceso directo al servidor.  Utiliza el servisor alpha como servidor vsftpd y utiliza un nuevo equiop con xubuntu con el filezilla instalado desde el cual se subiran y descargar archivos.  
