...
2. Configura los sitios webs necesarios en el directorio `/srv/webs/`.
...
5. Personaliza una página de error para el error 404
6. Revisa los logs de acceso y errores.

---

### Tarea 3: Creación de sitios virtuales
#### Objetivo
Configurar un nuevo sitio virtual fuera de los puertos estandars.

#### Instrucciones
1. Crea un nuevo sitio virtuales:
   - **www.ZQAlphapruebas.com:8080**: Web que utilizará el administrador de sistemas para realizar sus cometidos.
